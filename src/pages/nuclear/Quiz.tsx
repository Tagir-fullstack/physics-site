...
const questions: Question[] = [
  ...
  // 5 новых вопросов по анимациям
  {
    ...
    options: [
      ...
      "Альфа-частицы полностью поглощались фольгой и образовывали новый элемент",
  ...
  },
  {
    ...
    options: [
      ...
      "Из-за большой массы и двойного положительного заряда",
      "Из-за положительного заряда, малого размера и мало массы",
  ...
  },
  {
    ...
    options: [
      ...
      "Он превращается в нейтрон и испускает гамма квант",
  ...
  },
  {
    ...
    options: [
      ...
      "Ядро примерно в 10 000 раз меньше атома",
...
const surveyQuestions: SurveyQuestion[] = [
  ...
  { id: 'q8', question: 'Хотели бы вы видеть анимации по другим разделам физики?', type: 'boolean', required: true },
