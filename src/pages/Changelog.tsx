...
const changelog: ChangelogEntry[] = [
  {
    ...
    version: 'v1.3.0',
    changes: [
      'Новые видео: Опыт Резерфорда (1_RutherfordExperiment) и Альфа-распад (3_AlphaDecay)',
      'Подробные форматированные описания для видео Опыта Резерфорда и Альфа-распада (заголовки, списки, формулы, курсив)',
      'Поддержка JSX-описаний в PageTemplate (жирный текст, списки, верхние/нижние индексы, разделители)',
      'Исправлена озвучка текста: SpeakButton теперь извлекает текст из DOM через ref',
      'Кнопка «Назад» (серая) для возврата к предыдущему уроку на всех страницах',
      'Новый порядок уроков: Капельная модель ядра перенесена на 7-ю позицию',
      'Стили описаний: отступы между абзацами, отступы слева для списков',
    ],
  },
  {
    date: '09.02.2026',
